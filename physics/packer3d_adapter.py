...
def _objects_from_placement(p: dict, meta: dict[str, dict]) -> list[Object]:
    ...
    if not local_boxes or perm is None:
        return [_object_from_placement(p, meta)]
...
def scene_from_packer3d(
    ...
    *,
    ...
    objects = [obj for p in placements for obj in _objects_from_placement(p, meta)]
